...
class CocoDataset(utils.Dataset):
    ...
    def auto_download(self, dataDir, dataType, dataYear):
        ...
        if dataType == "minival":
            annZipFile = "{}/instances_val2014.json.zip".format(dataDir)
            annFile = "{}/instances_val2014.json".format(annDir)
            annURL = "https://dl.dropboxusercontent.com/s/o43o90bna78omob/instances_val2014.json.zip?dl=0"
            unZipDir = annDir
